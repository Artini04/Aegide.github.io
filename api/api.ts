...
let ANALYZED = 0
const content = document.getElementById('results') as HTMLDivElement
...
async function urlExists(url: string, callback: Function): Promise<void> {
...
function someCallback(url: string, isSuccess: boolean): void {
